...
4. Create “test set” branches off the development branch. As you merge those changes into development, your projects sementic versioning will sync SemVer minor with the number of “feature folders” in the “tests” folder. Write only fixtures and test sets on “test set” branches. When you merge changes to the features branch your agent should have all it needs to implement new features, while perserving any old ones. 
